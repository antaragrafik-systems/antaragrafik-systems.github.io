  ...
  L.Control.Ruler = L.Control.extend({
    ...
    _toggleMeasure: function () {
      ...
      if (this._choice) {
       //   alert("1");
         ...
         // alert("11");
        //  alert(this._totalLength);
         // alert(this._polylineLayer);
          if (this._polylineLayer != null  )
          {
             ...
             // alert("123");
              ...
              text =// '<b>' +   this.options.lengthUnit.label + '</b>'+
                ...
                '<br> &nbsp;' + this._clickedLatLong.lat.toFixed(5) + ',&nbsp;' + this._clickedLatLong.lng.toFixed(5);
          ...
          //var collection1 = this._polylineLayer.toGeoJSON();
          //alert(JSON.stringify(collection1));
          //alert(collection1.features.length);
          //alert(collection1.features[collection1.features.length - 1].geometry.coordinates);
          //alert(collection1.features[collection1.features.length - 1].geometry.coordinates.length);
          //alert(collection1.features[collection1.features.length - 1].geometry.coordinates[collection1.features[collection1.features.length - 1].geometry.coordinates.length-1]);
    ...
    _clicked: function (e) {
      ...
      if(this._clickCount > 0 && !e.latlng.equals(this._clickedPoints[this._clickedPoints.length - 2])){
        ...
        //        this.options.angleUnit.display + '<br><b>' + this.options.lengthUnit.label + '</b>&nbsp;' +
        //        this._totalLength.toFixed(this.options.lengthUnit.decimal) + '&nbsp;' +
        //        this.options.lengthUnit.display;
        //}
        //else {
    ...
    _moving: function(e) {
      if (this._clickedLatLong){
        ...
        if (this._clickCount > 1){
            text = '<b>' + this.options.angleUnit.label + '</b>&nbsp;' + this._result.Bearing.toFixed(this.options.angleUnit.decimal) + '&nbsp;' + this.options.angleUnit.display +
                '<br><b>' + this.options.lengthUnit.label + '</b>&nbsp;' + this._addedLength.toFixed(this.options.lengthUnit.decimal) + '&nbsp;' + this.options.lengthUnit.display +
                '<br><div class="plus-length">(+' + this._result.Distance.toFixed(this.options.lengthUnit.decimal) + ')</div>'+
                '<br><b>Lat,Long:</b>&nbsp;' + this._movingLatLong.lat.toFixed(5) + ',&nbsp;' + this._movingLatLong.lng.toFixed(5);
        }
        else {
            text = '<b>' + this.options.angleUnit.label + '</b>&nbsp;' + this._result.Bearing.toFixed(this.options.angleUnit.decimal) + '&nbsp;' + this.options.angleUnit.display +
                '<br><b>' + this.options.lengthUnit.label + '</b>&nbsp;' + this._result.Distance.toFixed(this.options.lengthUnit.decimal) + '&nbsp;' + this.options.lengthUnit.display +
                '<br><b>Lat,Long:</b>&nbsp;' + this._movingLatLong.lat.toFixed(5) + ',&nbsp;' + this._movingLatLong.lng.toFixed(5);
        }
